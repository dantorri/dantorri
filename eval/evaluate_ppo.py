...
#             episode_result = evaluate_episode(model, env, deterministic=args.deterministic)
#             results.append(episode_result)

#             print(f"\nEpisode {ep + 1}")
#             print(f"  reward              : {episode_result['episode_reward']:.2f}")
#             print(f"  steps               : {episode_result['episode_steps']}")
#             print(f"  forward distance    : {episode_result['forward_distance']:.3f} m")
#             print(f"  avg forward velocity: {episode_result['avg_forward_velocity']:.3f} m/s")
#             print(f"  fell                : {episode_result['fell']}")
#             print(f"  final base height   : {episode_result['final_base_height']:.3f}")
